...
import { pushQuestion } from "../../utils/questionEvents";
import { supabase, REALTIME_CHANNEL } from "../../utils/supabaseClient";
import { db, type Question, type Attendee } from "../../utils/database";
...
export function QuestionManager() {
  ...
  const handleCreateQuestion = async () => {
    ...
    setQuestions([...questions, { ...question, response_count: 0 }]);
