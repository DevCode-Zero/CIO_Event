...
import { Plus, Calendar, Clock, MapPin, X, Edit, Trash2, User, Building, FileText, Users } from "lucide-react";
import { db, type Meeting } from "../../utils/database";
import { saveMeetingsToStorage, saveFeaturedSpeaker, getFeaturedSpeaker } from "../../utils/meetingEvents";
          ...
          <>
            ...
            >
              <div className="sticky top-0 px-6 py-4 border-b border-border bg-secondary/30 backdrop-blur-xl flex items-center justify-between">
                <h3 style={{ fontSize: "1.25rem", fontWeight: 600 }}>Add New Session</h3>
                <button
                  onClick={() => setShowCreateModal(false)}
            ...
            >
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="flex gap-3 pt-4">
                  ...
                  <button
                    onClick={() => {
                      saveFeaturedSpeaker(featuredSpeaker);
